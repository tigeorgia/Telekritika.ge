 ...
 */
function discussion_handle_all_page($subtype = "group") {
 ...
 */
function discussion_handle_list_page($guid, $subtype = "group") {
 ...
 */
function discussion_handle_edit_page($type, $guid, $subtype = "group") {
	gatekeeper();
 ...
 */
function discussion_handle_view_page($guid, $subtype = "group") {
