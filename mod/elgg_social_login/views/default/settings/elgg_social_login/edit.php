...
?> 
	<p style="font-size: 14px;margin-left:10px;"> 
		<br /> 
		We highly recommend to first run the plugin requirements test and to read the plugin user guide. If you need further assistance, feel free to contact me at <b>hybridauth@gmail.com</b>
