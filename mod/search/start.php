...
//	elgg_register_plugin_hook_handler('search', 'group', 'search_groups_hook');
    ...
    elgg_register_plugin_hook_handler('search', 'events', 'search_events_hook');
	elgg_register_plugin_hook_handler('search', 'categories', 'search_categories_hook');
	...
	elgg_register_plugin_hook_handler('search', 'SMS', 'search_comments_hook');
...
/**
 * Page handler for browse
 *
 * @param array $page Page elements from pain page handler
 */
function browse_page_handler($page) {

	$base_dir = elgg_get_plugins_path() . 'search/pages/browse';
