...
if (isset($comment_info['dislikes']) && in_array(elgg_get_logged_in_user_guid(), $comment_info['dislikes'])) {
    system_message(elgg_echo("likes:alreadydisliked"));
    forward(REFERER);
}
...
if (is_array($comment_info)){
    $comment_info['dislikes'][(string)elgg_get_logged_in_user_guid()] = elgg_get_logged_in_user_guid();
    unset($comment_info['likes'][(string)elgg_get_logged_in_user_guid()]);
}else{
...
system_message(elgg_echo("likes:dislikes"));
