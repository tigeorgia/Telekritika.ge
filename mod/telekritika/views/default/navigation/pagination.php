...
//    $pages->prev['href'] = elgg_http_add_url_query_elements($base_url, array($offset_key => $prev_offset));
    $pages->prev['href']  = ($vars['paginate'] || $vars['data-refresh']) ? "#" : elgg_http_add_url_query_elements($base_url, array($offset_key => $prev_offset));
    $pages->prev['is_action'] = false;
    $pages->prev['data-offset'] = $prev_offset;
    $pages->prev['data-limit'] = $limit;
    $pages->prev['data-paginate'] = $vars['data-refresh'] ? $vars['data-refresh'] : $vars['data-paginate'];
    $pages->prev['data-pub'] = $vars['data-pub'];
    $pages->prev['data-rating_style'] = $vars['data-rating_style'];
...
//    $pages->next['href'] = elgg_http_add_url_query_elements($base_url, array($offset_key => $next_offset));
	$pages->next['href'] = ($vars['paginate'] || $vars['data-refresh']) ? "#" : elgg_http_add_url_query_elements($base_url, array($offset_key => $next_offset));
    $pages->next['is_action'] = false;
    $pages->next['data-offset'] = $next_offset;
    $pages->next['data-limit'] = $limit;
    $pages->next['data-paginate'] = $vars['data-refresh'] ? $vars['data-refresh'] : $vars['data-paginate'];
    $pages->next['data-pub'] = $vars['data-pub'];
    $pages->next['data-rating_style'] = $vars['data-rating_style'];
...
foreach ($pages->items as $page) {
	if ($page == $current_page) {
        ...
        $thispage['text'] = $page;
        $thispage['href'] = ($vars['paginate'] || $vars['data-refresh']) ? "#" : elgg_http_add_url_query_elements($base_url, array($offset_key => $page_offset));
        $thispage['is_action'] = false;
        $thispage['data-offset'] = $page_offset;
        $thispage['data-limit'] = $limit;
        $thispage['data-paginate'] = $vars['data-refresh'] ? $vars['data-refresh'] : $vars['data-paginate'];
        $thispage['data-pub'] = $vars['data-pub'];
        $thispage['data-rating_style'] = $vars['data-rating_style'];
        $link = elgg_view('output/url', $thispage);
