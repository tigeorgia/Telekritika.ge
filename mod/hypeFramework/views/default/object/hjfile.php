...
if ($full) {
    ...
    $fields_view = elgg_view('page/components/hj/fieldtable', array('entity' => $entity, 'fields' => $fields, 'viewtype' => $viewtype, 'intro' => $intro));
    $full_description = elgg_view('page/components/hj/fullview', array('entity' => $entity, 'content' => $preview . $fields_view, 'viewtype' => $viewtype, 'handler' => 'hjfile', 'extras' => array('file_guid' => $entity->guid)));
}
